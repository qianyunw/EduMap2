...
public class MyActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initItems();
        ItemAdapter adapter = new ItemAdapter (MyActivity.this, R.layout.my_item, itemList);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                appContext = MyActivity.this.getApplicationContext();
                //判断是否需要登录
                if(UCManager.getInstance().getCurrentUser() != null) { //用户已登录
                    ...
                    LoginActivity.launchForResult(MyActivity.this, REQUEST_CODE_LOGIN);
